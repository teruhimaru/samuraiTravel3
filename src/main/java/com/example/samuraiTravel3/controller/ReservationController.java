...
import com.example.samuraiTravel3.form.ReservationInputForm;
...
import com.example.samuraiTravel3.service.ReservationService;
import com.example.samuraiTravel3.service.StripeService;
...
public class ReservationController {
	...
	public String input(@PathVariable(name = "id") Integer id,
		...
		if(numberOfPeople != null) {
			if(!reservationService.isWithinCapacity(numberOfPeople, capacity)) {
				FieldError fieldError = new FieldError(bindingResult.getObjectName(), "numberOfPeople", "宿泊人数が手員を超えています。");
	...
	public String confirm(@PathVariable(name = "id") Integer id,
		...
		ReservationRegisterForm reservationRegisterForm = new ReservationRegisterForm(house.getId(),
				user.getId(), checkinDate.toString(), checkoutDate.toString(),
